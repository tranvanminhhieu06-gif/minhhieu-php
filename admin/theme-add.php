      ...
      <form method="POST" action="theme-add.php" class="glass-panel" style="padding:32px;">
        ...
        <div class="ceo-grid-4">
          ...
          <div class="form-group">
            ...
            <input type="color" name="secondary_color" value="#ec4899" class="glass-input" style="height:44px;padding:4px;">
          </div>
          <div class="form-group">
            <label class="form-label">Màu Nhấn:</label>
            <input type="color" name="accent_color" value="#06b6d4" class="glass-input" style="height:44px;padding:4px;">
          </div>
          <div class="form-group">
