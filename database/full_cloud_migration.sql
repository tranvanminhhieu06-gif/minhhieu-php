...
(4, 2, 'Hieu CyberTech Innovation Matrix', 'hieu-cybertech-gadgets', 'HIEU_WEB_04', 'Showroom Thiáº¿t Bá»‹ CÃ´ng Nghá»‡ & Há»‡ Sinh ThÃ¡i AI', 'Website bÃ¡n láº» Ä‘iá»‡n thoáº¡i flagship, laptop gaming, linh kiá»‡n PC vÃ  phá»¥ kiá»‡n thÃ´ng minh; tÃ­ch há»£p so sÃ¡nh thÃ´ng sá»‘ ká»¹ thuáº­t, báº£o hÃ nh Ä‘iá»‡n tá»­ vÃ  mua tráº£ gÃ³p 0%.', 'assets/images/themes/tech-preview.png', 'HieuWeb04/index.php', 'HieuWeb04', '2.5.0', 'HIEU CEO Studio', 'ready', 1, 4.97, 1890, 11400, '#8b5cf6', '#3b82f6', '#06b6d4', '#090d16', 'Outfit', 'executive_glass'),
