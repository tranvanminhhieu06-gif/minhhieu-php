...
(6, 'Nền Tảng Doanh Nghiệp SaaS', 'saas', 'fa-cloud-arrow-up', 'Giao diện quản trị điện toán đám mây, AI Automation, giải pháp chuyển đổi số cho tập đoàn', 'Enterprise', 6),
(7, 'Bất Động Sản & Nghỉ Dưỡng', 'realestate', 'fa-building-columns', 'Giao diện mở bán căn hộ biệt thự hạng sang, villa nghỉ dưỡng, quản lý tour du lịch VIP', 'Ultra Luxury', 7);
...
(1, 1, 'HieuMini Luxury Fashion Studio', 'hieumini-fashion-studio', 'HIEU_WEB_01', 'Đỉnh Cao Thương Mại Điện Tử May Mặc & Lookbook 3D', 'Hệ thống website thời trang may mặc thế hệ mới với Hero Slider trình chiếu bộ sưu tập, Flash Sale đồng hồ đếm ngược, bộ lọc size/giá đa chiều, Size Guide quy đổi kích cỡ và giỏ hàng thông minh tích hợp VietQR MBBank.', 'assets/images/themes/fashion-preview.png', 'HieuWeb01/index.php', 'HieuWeb01', '2.4.0', 'HIEU CEO Studio', 'active', 1, 4.98, 1420, 8940, '#6366f1', '#ec4899', '#06b6d4', '#0f172a', 'Outfit', 'executive_glass'),
(2, 3, 'Hieu Modern Book & Publishing Hub', 'hieu-modern-bookstore', 'HIEU_WEB_02', 'Không Gian Đọc Đẳng Cấp & Thư Viện Tri Thức Số', 'Giao diện hiệu sách sang trọng với danh mục đa dạng từ văn học, kinh tế, công nghệ đến kỹ năng sống; hỗ trợ đọc thử mẫu, đánh giá độc giả, mã giảm giá và trang cá nhân theo dõi đơn.', 'assets/images/themes/book-preview.png', 'HieuWeb02/index.php', 'HieuWeb02', '2.1.0', 'HIEU CEO Studio', 'ready', 1, 4.93, 1150, 6420, '#0284c7', '#f59e0b', '#10b981', '#0b1329', 'Plus Jakarta Sans', 'executive_glass'),
(3, 4, 'Hieu Living & Scandinavian Decor', 'hieu-living-decor', 'HIEU_WEB_03', 'Kiến Trúc Nội Thất Tinh Tế Cho Không Gian Sống Xanh', 'Giao diện nội thất theo phong cách tối giản Bắc Âu, tối ưu hình ảnh sản phẩm góc rộng, bộ sưu tập phòng khách, phòng ngủ, phòng làm việc cùng tư vấn thiết kế nội thất cá nhân hóa.', 'assets/images/themes/furniture-preview.png', 'HieuWeb03/index.php', 'HieuWeb03', '2.2.0', 'HIEU CEO Studio', 'ready', 1, 4.96, 980, 5200, '#10b981', '#64748b', '#f59e0b', '#0f172a', 'Outfit', 'executive_glass'),
(4, 2, 'Hieu CyberTech Innovation Matrix', 'hieu-cybertech-gadgets', 'HIEU_WEB_04', 'Showroom Thiết Bị Công Nghệ & Hệ Sinh Thái AI', 'Website bán lẻ điện thoại flagship, laptop gaming, linh kiện PC và phụ kiện thông minh; tích hợp so sánh thông số kỹ thuật, bảo hành điện tử và mua trả góp 0%.', 'assets/images/themes/tech-preview.png', 'HieuWeb04/index.php', 'HieuWeb04', '2.5.0', 'HIEU CEO Studio', 'ready', 1, 4.97, 1890, 11400, '#8b5cf6', '#3b82f6', '#06b6d4', '#090d16', 'Outfit', 'executive_glass'),
(5, 5, 'Hieu Pro Gym & Athletic Matrix', 'hieu-gym-fitness-pro', 'HIEU_WEB_05', 'Nền Tảng Thể Hình Đỉnh Cao & Dinh Dưỡng Thể Thao', 'Website phòng tập Gym & phân phối thực phẩm bổ sung Whey Isolate, Creatine; tích hợp công cụ tính toán chỉ số BMI khoa học, lịch tập cá nhân và gói tập PT cao cấp.', 'assets/images/themes/gym-preview.png', 'HieuWeb05/index.php', 'HieuWeb05', '2.6.0', 'HIEU CEO Studio', 'ready', 1, 4.99, 2140, 14250, '#ef4444', '#f97316', '#eab308', '#0b0f19', 'Montserrat', 'executive_glass'),
(6, 6, 'Hieu Obsidian AI & Cloud Enterprise', 'hieu-obsidian-ai-saas', 'HIEU_WEB_06', 'Giải Pháp Chuyển Đổi Số & Tự Động Hóa Trí Tuệ Nhân Tạo', 'Giao diện SaaS dành cho tập đoàn quy mô lớn với Dashboard thời gian thực, bảng giá đăng ký định kỳ, tích hợp API Gateway và báo cáo dữ liệu Big Data chuẩn điều hành.', 'assets/images/themes/saas-preview.png', 'index.php?demo=saas', 'HieuWebSaaS', '3.0.0', 'HIEU CEO Studio', 'ready', 1, 5.00, 3100, 18900, '#6366f1', '#a855f7', '#38bdf8', '#070b14', 'Outfit', 'executive_glass'),
(7, 7, 'Hieu Diamond Luxury Real Estate', 'hieu-diamond-estates', 'HIEU_WEB_07', 'Sàn Bất Động Sản Hạng Sang & Nghỉ Dưỡng Thượng Lưu', 'Giao diện trình diễn các siêu dự án căn hộ Penthouse, biệt thự biển, resort nghỉ dưỡng 6 sao với công nghệ thực tế ảo VR 360 và hồ sơ pháp lý minh bạch cho giới đầu tư.', 'assets/images/themes/realestate-preview.png', 'index.php?demo=estate', 'HieuWebEstate', '1.8.0', 'HIEU CEO Studio', 'beta', 0, 4.91, 640, 3800, '#d97706', '#b45309', '#fbbf24', '#0f141c', 'Cinzel', 'executive_glass');
